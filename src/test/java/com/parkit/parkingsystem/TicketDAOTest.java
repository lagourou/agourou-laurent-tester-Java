...
class TicketDAOTest {
    ...
    @Test
    void testSaveTicket_Exception() throws ClassNotFoundException, SQLException {
        ticket = new Ticket();
        ticket.setParkingSpot(new ParkingSpot(1, null, false));
        ticket.setVehicleRegNumber(VEHICLE_REG_NUMBER);
        ticket.setPrice(15.0);
    ...
    @Test
    void testSaveTicket_RowsAffectedGreaterThanZero() throws ClassNotFoundException, SQLException {
    ticket = new Ticket();
    ticket.setParkingSpot(new ParkingSpot(1, null, false));
    ticket.setVehicleRegNumber(VEHICLE_REG_NUMBER);
    ticket.setPrice(15.0);
    ...
    verify(logger, times(1)).info("Ticket inséré avec succès pour le véhicule {}", ticket.getVehicleRegNumber());
    }

    @Test
    void testSaveTicket_RowsAffectedEqualsZero() throws ClassNotFoundException, SQLException {
    ticket = new Ticket();
    ticket.setParkingSpot(new ParkingSpot(1, null, false));
    ticket.setVehicleRegNumber(VEHICLE_REG_NUMBER);
    ticket.setPrice(15.0);
    ...
    verify(logger, times(1)).error("Échec de l'insertion du ticket pour le véhicule {}", ticket.getVehicleRegNumber());
    }
        @Test
        void testGetTicket_Success() throws SQLException, ClassNotFoundException {
            ...
            verify(logger, times(0)).info("Aucun ticket trouvé pour le véhicule {}", VEHICLE_REG_NUMBER);
            verify(logger, times(0)).error(toString());
        }
        ...
        void testGetTicket_NotFound() throws SQLException, ClassNotFoundException {
            ...
            assertNull(ticket);
            verify(logger, times(1)).info("Aucun ticket trouvé pour le véhicule {}", VEHICLE_REG_NUMBER);
            verify(logger, times(0)).error(toString());
        }
        ...
        void testGetTicket_Exception() throws SQLException, ClassNotFoundException {
            ...
            verify(logger, times(0)).info(toString());
            verify(logger, times(1)).error(
        eq("Erreur lors de la récupération du ticket pour le véhicule: {}"),
        eq(VEHICLE_REG_NUMBER),
        any(SQLException.class));
        }
        

    @Test
    void testGetNbTicket_Success() throws SQLException, ClassNotFoundException {
        when(preparedStatement.executeQuery()).thenReturn(resultSet);
        when(resultSet.next()).thenReturn(true);
    ...
    @Test
    void testGetNbTicket_NoResult() throws SQLException, ClassNotFoundException  {
        when(preparedStatement.executeQuery()).thenReturn(resultSet);
        when(resultSet.next()).thenReturn(false);
    ...
    @Test
    void testGetNbTicket_Exception() throws SQLException, ClassNotFoundException {
    ...
    @Test
    void testUpdateTicket_Success() throws SQLException, ClassNotFoundException {
        ...
        verify(logger).info("Ticket avec l'ID mis à jour avec succès {}", 1);
    }

    @Test
    void testUpdateTicket_Failure() throws SQLException, ClassNotFoundException {
        ...
        verify(preparedStatement).setInt(3, 1);
        verify(preparedStatement).executeUpdate();
        verify(logger).error("Erreur lors de la mise à jour du ticket avec l'ID {}", 1);
    }
}
